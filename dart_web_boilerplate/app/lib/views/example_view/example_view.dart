...
import 'package:dart_web_boilerplate/views/example_view/enum_example_view.dart';
import 'package:flutter/material.dart';
import 'package:smvp_dart/smvp.dart';

final class ExampleView extends StatefulWidget {
...
final class _ExampleViewState extends State<ExampleView> {
  // Final variables
  ...
  Widget build(BuildContext context) {
    ...
    switch (getViewState()) {
      case EnumExampleView.isLoading:
      ...
      case EnumExampleView.exception:
        return AdaptiveLayout.getAdaptiveWidget(
          context,
  ...
  EnumExampleView getViewState() {
    if (_isLoading) {
      return EnumExampleView.isLoading;
    }
    if (_exceptionAdapter.hasException()) {
      return EnumExampleView.exception;
    }
    return EnumExampleView.success;
  }
